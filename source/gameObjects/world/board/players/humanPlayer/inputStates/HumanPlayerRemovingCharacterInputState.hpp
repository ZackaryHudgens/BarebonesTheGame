#ifndef HUMANPLAYERREMOVINGCHARACTERINPUTSTATE_HPP
#define HUMANPLAYERREMOVINGCHARACTERINPUTSTATE_HPP
...
namespace Barebones
{
  class HumanPlayerRemovingCharacterInputState : public HumanPlayerInputState
  {
    public:
       ...
       */
      HumanPlayerRemovingCharacterInputState(UrsineEngine::GameObject& aPlayer);
