#ifndef REWARDSMENUINPUTCOMPONENT_HPP
#define REWARDSMENUINPUTCOMPONENT_HPP

#include "InputComponent.hpp"

namespace Barebones
{
  class RewardsMenuInputComponent : public InputComponent
  {
    public:
